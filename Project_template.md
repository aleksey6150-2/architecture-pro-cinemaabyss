...
![Kafka topics - screen1](results/img/kafka-screen1.png)
![Kafka topics - screen2](results/img/kafka-screen2.png)
...
![Тесты прошли и образы появились в регистре](results/img/task3-1.png)

#### Шаг 3
Добавьте сюда скриншота вывода при вызове https://cinemaabyss.example.com/api/movies и  скриншот вывода event-service после вызова тестов.

![Прогон тестов в кубере и запрос api/movies](results/img/task3-3-all.jpg)
## Задание 4

после правок helm upgrate все развернулось
![img_1.png](results/img/task4-1.jpg)

/api/movies отобразилось
![task4-2.png](results/img/task4-2.png)


# Задание 5
Приложите скриншот работы circuit breaker'а
![taks5.jpg](results/img/taks5.jpg)
