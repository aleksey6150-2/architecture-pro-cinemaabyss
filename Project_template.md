...
```markdown
[Диаграмма контейнеров микросервисной системы "Кинобездна"](https://github.com/aleksey6150-2/architecture-pro-cinemaabyss/blob/cinema/schemas/png/01_to_be.png)
```
